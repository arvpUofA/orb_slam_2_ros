 ...
 */
 ...
 public:
   Node(const std::string &node_name, const rclcpp::NodeOptions &node_options);
 ...
 protected:
   ...
   std::shared_ptr<image_transport::ImageTransport>
       image_transport_; // Not used in StereoNode, H264StereoNode
 ...
 private:
   ...
   void
   SaveMapSrv(const shared_ptr<rmw_request_id_t> /*request_header*/,
   ...
   MapPointsToPointCloud(std::vector<ORB_SLAM2::MapPoint *> map_points);
   ...
   rclcpp::Subscription<sensor_msgs::msg::CameraInfo>::SharedPtr
       camera_info_sub_; // Not used in H264StereoNode
